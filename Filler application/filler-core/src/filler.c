...
static void filler_algo_iterative(uint8_t* source_data, int width, int height, int channels, filler_color_t final_color, filler_color_t sampled_color, bool* pixel_cache, filler_stacki_t* pixel_stack) 
{
